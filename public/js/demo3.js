 ...
 */
    ...
    const mainContainer = document.getElementById('mouse-tray-container');
    ...
    const getMousePos = (ev) => {
        ...
        if (ev.pageX || ev.pageY) {
            ...
            posx = ev.clientX + mainContainer.scrollLeft + docEl.scrollLeft;
            posy = ev.clientY + mainContainer.scrollTop + docEl.scrollTop;
        }
    ...
    class Image {
        ...
        isActive() {
            ...
            return (
                TweenMax.isTweening(this.DOM.el) ||
